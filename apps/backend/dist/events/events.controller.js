...
let EventsController = class EventsController {
    ...
    getTimeline(patientId, req, query) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Devuelve vacunas, vitales y eventos en orden cronológico descendente. Usa `cursor` (ISO date) para la siguiente página. El campo `type` indica el origen: vaccine, vital, medication_given, symptom, visit, exam, note.',
    }),
