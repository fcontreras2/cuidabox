...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Retorna citas paginadas (scheduled, completed y cancelled) en orden descendente. Usa `cursor` (ISO date) para obtener la siguiente página.',
    }),
