...
let DocumentsController = class DocumentsController {
    ...
    findAll(patientId, req, treatment_id, appointment_id, exam_id, query) {
        return this.documentsService.findAll(patientId, req.user.id, { treatment_id, appointment_id, exam_id }, query);
    }
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Retorna documentos paginados. Filtra opcionalmente por treatment_id, appointment_id o exam_id. Usa `cursor` (ISO date) para la siguiente página.',
    }),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object, String, String, String, pagination_query_dto_1.PaginationQueryDto]),
    __metadata("design:returntype", void 0)
