...
export declare class DocumentsController {
    ...
    findAll(patientId: string, req: AuthRequest, treatment_id?: string, appointment_id?: string, exam_id?: string, query?: PaginationQueryDto): Promise<import("../common/types/paginated").Paginated<import("./documents.service").Document>>;
